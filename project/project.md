...
**Due Dates:**
  ...
  - [Milestone 2: Literature Survey](#milestone-2-literature-review) - 03/08 (40 points)
  - [Milestone 3: Design Document](#milestone-3-design-document) - 03/29 (50 points)
  - [Milestone 4: Final Presentation](#milestone-4-final-report) - 05/03 (100 points)
...
**Submission Instructions:**
  ...
  - The team leader should [create the team repository using GitHub Classrooms](https://classroom.github.com/a/Mwg-fZxu), entering the chosen team name. Make sure that nobody else has already picked your name!  Other team members should then join the team. *It is hard for us to delete teams or move people between them, so be careful and don't join the wrong team! We may deduct points if you cause us extra work.*
